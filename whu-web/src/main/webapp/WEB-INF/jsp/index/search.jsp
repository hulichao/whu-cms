	...
	<div class="am-g am-g-fixed">
		<div>
			<ol class="am-breadcrumb am-breadcrumb am-margin-vertical-0 br_bt">
				...
				<li class="am-active">标签内容：[${con }]</li>
			</ol>
		</div>
	</div>
	<div class="am-g am-g-fixed">
			...
			<div class="am-panel-group">
				<section class="am-panel am-panel-default">
					<div data-am-widget="" class="am-titlebar-default">
						<h2 class="am-titlebar-title">检索栏目</h2>
					...
					<ul class="am-nav">
						<c:forEach var="c" items="${cs}">
							...
							<c:if test="${c.name ne channel.name}">
								<li><a href="<%=request.getContextPath()%>/channel/${c.id }">${c.name }</a></li>
							</c:if>
						</c:forEach>
					</ul>
				</section>
		...
		<div class="am-u-md-9">
			<div data-am-widget="list_news"
				...
				<div class="am-list-news-hd am-cf">
					<%--带更多链接--%>
					<h2>
						<span class="am-icon-list-ul"></span> 标签内容：[${con }]
					</h2>
				</div>
