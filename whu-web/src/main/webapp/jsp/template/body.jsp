		...
		<div data-am-widget="list_news" class="am-list-news am-list-news-default">
			...
			<div class="am-list-news-bd">
				<ul class="am-list">
					...
					<li class="am-g am-list-item-dated"><a href="topic/77" class="am-list-item-hd ">史上最大屏幕！牛人打造“苹果智能镜子”</a> <span class="am-list-date">2016-11-27</span></li>
					<li class="am-g am-list-item-dated"><a href="topic/76" class="am-list-item-hd ">火焰之纹章</a> <span class="am-list-date">2016-11-27</span></li>
					<li class="am-g am-list-item-dated"><a href="topic/74" class="am-list-item-hd ">冷战核动力飞机的疯狂尝试：若试验成功可无限滞空?</a> <span class="am-list-date">2016-11-27</span></li>
					<li class="am-g am-list-item-dated"><a href="topic/73" class="am-list-item-hd ">日媒：中国开辟北冰洋航线 日俄拟加强远东防卫合作</a> <span class="am-list-date">2016-11-27</span></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="am-g am-g-fixed  cms-fixed">
	<div class="am-u-md-6 am-u-sm-12">
		<div data-am-widget="titlebar" class="am-titlebar am-titlebar-default">
			<h2 class="am-titlebar-title ">基金</h2>
			<nav class="am-titlebar-nav">
				<a href="channel/13" class="">more &raquo;</a>
			</nav>
		</div>
		<div data-am-widget="list_news" class="am-list-news am-list-news-default">
			<!--列表标题-->
			<ul class="am-list">
				<li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-u-sm-3 am-list-thumb">
						<a href="topic/71"> <img src="http://p1.ifengimg.com/fck/2016_48/ba19d7e599b503a_w600_h337.jpg" alt="标普500创历史新高 易方达加码布局美股指基" />
						</a>
					</div>
				...
				<li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-u-sm-3 am-list-thumb">
						<a href="topic/70"> <img src="http://p1.ifengimg.com/fck/2016_48/ba19d7e599b503a_w600_h337.jpg" alt="博时基金魏凤春：预计债市短期或陷入调整" />
						</a>
					</div>
					<div class=" am-u-sm-9 am-list-main">
				...
				<li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-u-sm-3 am-list-thumb">
						<a href="topic/69"> <img src="http://p1.ifengimg.com/fck/2016_48/ba19d7e599b503a_w600_h337.jpg" alt="低风险需求驱动 定开债基成“爆款”产品" />
						</a>
					</div>
					<div class=" am-u-sm-9 am-list-main">
	...
	<div class="am-u-md-6 am-u-sm-12">
		<div data-am-widget="titlebar" class="am-titlebar am-titlebar-default">
			<h2 class="am-titlebar-title ">商业</h2>
			<nav class="am-titlebar-nav">
				<a href="channel/14" class="">more &raquo;</a>
			</nav>
		</div>
		<div data-am-widget="list_news" class="am-list-news am-list-news-default">
			<!--列表标题-->
			<ul class="am-list">
				<li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-u-sm-3 am-list-thumb">
						<a href="topic/65"> <img src="http://p1.ifengimg.com/fck/2016_48/ba19d7e599b503a_w600_h337.jpg" alt="被禁入华澳乳企老板来自中国 被曝使用过期奶粉" />
						</a>
					</div>
					<div class=" am-u-sm-9 am-list-main">
				...
				<li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-u-sm-3 am-list-thumb">
						<a href="topic/63"> <img src="http://p1.ifengimg.com/fck/2016_48/ba19d7e599b503a_w600_h337.jpg" alt="孵化器倒闭潮来临？数量太多创业者不够用" />
						</a>
					</div>
					<div class=" am-u-sm-9 am-list-main">
				...
				<li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-u-sm-3 am-list-thumb">
						<a href="topic/64"> <img src="http://p1.ifengimg.com/fck/2016_48/ba19d7e599b503a_w600_h337.jpg" alt="四五百元平衡车靠谱吗？成本都要七八百！" />
						</a>
					</div>
					<div class=" am-u-sm-9 am-list-main">
        ...
        <div class="am-panel-group am-hide-sm-only">
            ...
            <section class="am-panel am-panel-default">
                ...
                <div class="am-panel-bd">
                    <a href="keyword/智能" class="am-badge am-badge-primary am-text-sm am-radius am-badge-danger">智能</a>
                    <a href="keyword/基金" class="am-badge am-badge-primary am-text-sm am-radius am-badge-primary">基金</a>
                    <a href="keyword/商业" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">商业</a>
                    <a href="keyword/变废为宝" class="am-badge am-badge-primary am-text-sm am-radius am-badge">变废为宝</a>
                    <a href="keyword/推荐" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">推荐</a>
                    <a href="keyword/平衡车" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">平衡车</a>
                    <a href="keyword/美国总统大选" class="am-badge am-badge-primary am-text-sm am-radius am-badge">美国总统大选</a>
                    <a href="keyword/特朗普" class="am-badge am-badge-primary am-text-sm am-radius am-badge-danger">特朗普</a>
                    ...
                    <a href="keyword/纸上谈兵" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">纸上谈兵</a>
                    <a href="keyword/生活" class="am-badge am-badge-primary am-text-sm am-radius am-badge">生活</a>
                    ...
                    <a href="keyword/任天堂" class="am-badge am-badge-primary am-text-sm am-radius am-badge-warning">任天堂</a>
                    <a href="keyword/是我的" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">是我的</a>
                    <a href="keyword/禁入" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">禁入</a>
                    <a href="keyword/美联储" class="am-badge am-badge-primary am-text-sm am-radius am-badge-danger">美联储</a>
                    <a href="keyword/飞机" class="am-badge am-badge-primary am-text-sm am-radius am-badge">飞机</a>
                    <a href="keyword/基金的" class="am-badge am-badge-primary am-text-sm am-radius am-badge-primary">基金的</a>
                    <a href="keyword/关键" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">关键</a>
                    <a href="keyword/习近平" class="am-badge am-badge-primary am-text-sm am-radius am-badge">习近平</a>
                    <a href="keyword/低风险" class="am-badge am-badge-primary am-text-sm am-radius am-badge-danger">低风险</a>
                    <a href="keyword/原标题" class="am-badge am-badge-primary am-text-sm am-radius am-badge-warning">原标题</a>
                    ...
                    <a href="keyword/师生" class="am-badge am-badge-primary am-text-sm am-radius am-badge-warning">师生</a>
                    <a href="keyword/学生工作" class="am-badge am-badge-primary am-text-sm am-radius am-badge-primary">学生工作</a>
                    <a href="keyword/火纹" class="am-badge am-badge-primary am-text-sm am-radius am-badge">火纹</a>
                    <a href="keyword/内地和香港" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">内地和香港</a>
                    <a href="keyword/孵化器" class="am-badge am-badge-primary am-text-sm am-radius am-badge-danger">孵化器</a>
                    <a href="keyword/美女" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">美女</a>
                    <a href="keyword/逆回购" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">逆回购</a>
                    <a href="keyword/创业者" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">创业者</a>
                    <a href="keyword/核动力" class="am-badge am-badge-primary am-text-sm am-radius am-badge-primary">核动力</a>
                    <a href="keyword/正式启" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">正式启</a>
                    ...
                    <a href="keyword/新闻" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">新闻</a>
                    <a href="keyword/开心" class="am-badge am-badge-primary am-text-sm am-radius am-badge-warning">开心</a>
                    ...
                    <a href="keyword/创业" class="am-badge am-badge-primary am-text-sm am-radius am-badge-warning">创业</a>
                    <a href="keyword/深港通" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">深港通</a>
                    <a href="keyword/关键字" class="am-badge am-badge-primary am-text-sm am-radius am-badge-secondary">关键字</a>
                    <a href="keyword/过期奶粉" class="am-badge am-badge-primary am-text-sm am-radius am-badge">过期奶粉</a>
                    <a href="keyword/棋子" class="am-badge am-badge-primary am-text-sm am-radius am-badge-success">棋子</a>
                    <a href="keyword/字数" class="am-badge am-badge-primary am-text-sm am-radius am-badge">字数</a>
                    <a href="keyword/华澳乳企老板" class="am-badge am-badge-primary am-text-sm am-radius am-badge-warning">华澳乳企老板</a>
				</div>
            </section>
        </div>
    </div>
