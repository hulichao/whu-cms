		...
		<ul class="am-list admin-sidebar-list" id="collapase-nav-1">
			...
			<li class="am-panel"><a class="am-cf" data-am-collapse="{parent:'#collapase-nav-1', target: '#collapse-nav'}"><span class="am-icon-user"></span>
				...
				<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav" onclick="return false;">
					<li><a href="#user" class="am-cf"><span class="am-icon-info"></span> 用户信息管理<span
							class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
					<li><a href="#group" class="am-cf"><span class="am-icon-group"></span> 用户组管理<span
							class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
					<li><a href="#role" class="am-cf"><span class="am-icon-child"></span> 用户角色管理<span
							class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
				</ul></li>
			</c:if>
			<li class="am-panel"><a class="am-cf" data-am-collapse="{parent:'#collapase-nav-1', target: '#collapse-nav1'}"><span
				...
				<c:if test="${isAdmin }">
					<li><a href="#channel" class="am-cf"><span class="am-icon-navicon"></span> 栏目信息管理<span
							class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
				</c:if>
					<li><a href="#topic" class="am-cf"><span class="am-icon-file-text-o"></span> 文章信息管理<span
							class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
				</ul></li>
			<c:if test="${isAdmin }">
				<li class="am-panel"><a class="am-cf" data-am-collapse="{parent:'#collapase-nav-1', target: '#collapse-nav2'}"><span class="am-icon-cogs"></span>
					...
					<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav2" onclick="return false;">
						<li><a href="#cmsLink" class="am-cf"><span class="am-icon-link"></span> 超级链接管理<span
								class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
						<li><a href="#system/baseInfo" class="am-cf"><span class="am-icon-sitemap"></span> 网站信息管理<span
								class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
						<li><a href="#pic/indexPic" class="am-cf"><span class="am-icon-picture-o"></span> 首页图片管理<span
								class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
						<li><a href="#backup" class="am-cf"><span class="am-icon-database"></span> 网站数据备份<span
								class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
						<li><a href="#system/clean" class="am-cf"><span class="am-icon-wrench"></span> 系统清理管理<span
								class="am-fr am-margin-right admin-icon-yellow"></span></a></li>
					</ul>
				</li>
			</c:if>
